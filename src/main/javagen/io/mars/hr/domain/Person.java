...
public final class Person implements Entity {
	 ...
	 */
	@Field(domain = "STyLabel", label = "First Name")
	 ...
	 */
	@Field(domain = "STyLabel", label = "Last Name")
	 ...
	 * @return String email
	 */
	@Field(domain = "STyEmail", label = "E-mail")
	 ...
	 */
	@Field(domain = "STyLabel", persistent = false, label = "Picture")
	 ...
	 */
	@Field(domain = "STyLocaldate", label = "Date hired")
	 ...
	 * @return Long groupId
	 */
	@io.vertigo.datamodel.structure.stereotype.ForeignKey(domain = "STyId", label = "Group", fkDefinition = "DtGroups" )
	 ...
	 */
	@Field(domain = "STyLabel", type = "COMPUTED", cardinality = io.vertigo.core.lang.Cardinality.ONE, persistent = false, label = "Full name")
