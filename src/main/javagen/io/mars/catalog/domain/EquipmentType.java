...
public final class EquipmentType implements Entity {
	 ...
	 * @return String label
	 */
	@Field(domain = "STyLabel", label = "Equipment Type Label")
	 ...
	 */
	@Field(domain = "STyYesNo", label = "Equipment type is active")
	 ...
	 */
	@io.vertigo.datamodel.structure.stereotype.ForeignKey(domain = "STyId", label = "Equipment Category", fkDefinition = "DtEquipmentCategory" )
