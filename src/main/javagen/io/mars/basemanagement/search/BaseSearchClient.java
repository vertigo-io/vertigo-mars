 ...
 */
@Generated
@io.vertigo.datafactory.search.metamodel.annotation.SearchIndexAnnotation(name = "IdxBase", dtIndex = "DtBaseIndex", keyConcept = "DtBase", loaderId = "BaseSearchLoader")
public final class BaseSearchClient implements Component {
	...
	@io.vertigo.datafactory.search.metamodel.annotation.FacetedQueryAnnotation(
		...
		facets = {
			...
			@io.vertigo.datafactory.search.metamodel.annotation.Facet(
				...
				label = "Creation Date",
				ranges = {
					@io.vertigo.datafactory.search.metamodel.annotation.Range(code = "r1", filter = "creationDate:[01/01/2008 TO 01/01/2012]", label = "2008-2012"),
					@io.vertigo.datafactory.search.metamodel.annotation.Range(code = "r2", filter = "creationDate:[01/01/2012 TO 01/01/2016]", label = "2012-2016"),
					@io.vertigo.datafactory.search.metamodel.annotation.Range(code = "r3", filter = "creationDate:[01/01/2016 TO *]", label = "after 2016")},
