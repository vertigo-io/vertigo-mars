...
public final class EquipmentIndex implements DtObject {
	 ...
	 */
	@Field(domain = "STyId", cardinality = io.vertigo.core.lang.Cardinality.ONE, label = "Id")
	 ...
	 * @return String tags
	 */
	@Field(domain = "STyTags", label = "Tags")
	 ...
	 */
	@Field(domain = "STyLabel", label = "Type")
	 ...
	 */
	@Field(domain = "STyLabel", label = "Category")
	 ...
	 */
	@Field(domain = "STyDescription", type = "COMPUTED", persistent = false, label = "ALL_TEXT")
