...
public final class Base implements KeyConcept {
	 ...
	 */
	@io.vertigo.datamodel.structure.stereotype.ForeignKey(domain = "STyCode", label = "Base Type", fkDefinition = "DtBaseType" )
	 ...
	 */
	@io.vertigo.datamodel.structure.stereotype.ForeignKey(domain = "STyId", label = "Base Geosector", fkDefinition = "DtGeosector" )
