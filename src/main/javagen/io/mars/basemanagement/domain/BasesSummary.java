...
public final class BasesSummary implements DtObject {
	 ...
	 */
	@Field(domain = "STyCount", cardinality = io.vertigo.core.lang.Cardinality.ONE, label = "Bases count")
	 ...
	 */
	@Field(domain = "STyHealth", cardinality = io.vertigo.core.lang.Cardinality.ONE, label = "Name")
	 ...
	 */
	@Field(domain = "STyCount", cardinality = io.vertigo.core.lang.Cardinality.ONE, label = "Health Level")
	 ...
	 */
	@Field(domain = "STyHealth", cardinality = io.vertigo.core.lang.Cardinality.ONE, label = "Equipment Health")
