...
public final class BasesSummary implements DtObject {
	 ...
	 */
	@Field(domain = "DoCount", cardinality = io.vertigo.core.lang.Cardinality.ONE, label = "Bases count")
	 ...
	 */
	@Field(domain = "DoHealth", cardinality = io.vertigo.core.lang.Cardinality.ONE, label = "Name")
	 ...
	 */
	@Field(domain = "DoCount", cardinality = io.vertigo.core.lang.Cardinality.ONE, label = "Health Level")
	 ...
	 */
	@Field(domain = "DoHealth", cardinality = io.vertigo.core.lang.Cardinality.ONE, label = "Equipment Health")
