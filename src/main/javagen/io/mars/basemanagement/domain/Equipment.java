...
public final class Equipment implements KeyConcept {
	 ...
	 * @return Long baseId
	 */
	@io.vertigo.datamodel.structure.stereotype.ForeignKey(domain = "STyId", label = "Base", fkDefinition = "DtBase" )
	 ...
	 */
	@io.vertigo.datamodel.structure.stereotype.ForeignKey(domain = "STyId", label = "Equipment Geosector", fkDefinition = "DtGeosector" )
	 ...
	 */
	@io.vertigo.datamodel.structure.stereotype.ForeignKey(domain = "STyId", label = "Business", fkDefinition = "DtBusiness" )
	 ...
	 */
	@io.vertigo.datamodel.structure.stereotype.ForeignKey(domain = "STyId", label = "Equipment Type", fkDefinition = "DtEquipmentType" )
