...
public final class BaseOverview implements DtObject {
	 ...
	 */
	@Field(domain = "STyCount", cardinality = io.vertigo.core.lang.Cardinality.ONE, label = "Equipments count")
	 ...
	 */
	@Field(domain = "STyCount", cardinality = io.vertigo.core.lang.Cardinality.ONE, label = "Open tickets")
	 ...
	 */
	@Field(domain = "STyCount", cardinality = io.vertigo.core.lang.Cardinality.ONE, label = "Work Orders in progress")
