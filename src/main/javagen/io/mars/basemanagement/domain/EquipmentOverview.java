 ...
 */
@Generated
public final class EquipmentOverview implements DataObject {
	 ...
	 */
	@Field(smartType = "STyId", label = "Business Id")
	 ...
	 * @return Long count
	 */
	@Field(smartType = "STyCount", label = "Count by business")
	 ...
	 * @return Long okCount
	 */
	@Field(smartType = "STyCount", label = "Ok count")
	 ...
	 */
	@Field(smartType = "STyCount", label = "Down count")
