...
public final class WorkOrder implements Entity {
	 ...
	 */
	@io.vertigo.dynamo.domain.stereotype.ForeignKey(domain = "STyId", label = "Ticket", fkDefinition = "DtTicket" )
	 ...
	 */
	@io.vertigo.dynamo.domain.stereotype.ForeignKey(domain = "STyCode", label = "Work Order Status", fkDefinition = "DtWorkOrderStatus" )
