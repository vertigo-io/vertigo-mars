...
public final class WorkOrder implements Entity {
	 ...
	 * @return String code
	 */
	@Field(domain = "STyLabel", label = "Code")
	 ...
	 */
	@Field(domain = "STyLocaldate", label = "Due Date")
	 ...
	 */
	@io.vertigo.datamodel.structure.stereotype.ForeignKey(domain = "STyId", label = "Ticket", fkDefinition = "DtTicket" )
	 ...
	 */
	@io.vertigo.datamodel.structure.stereotype.ForeignKey(domain = "STyCode", label = "Work Order Status", fkDefinition = "DtWorkOrderStatus" )
