...
public final class Ticket implements Entity {
	 ...
	 */
	@io.vertigo.datamodel.structure.stereotype.ForeignKey(domain = "STyCode", label = "Ticket Status", fkDefinition = "DtTicketStatus" )
	 ...
	 */
	@io.vertigo.datamodel.structure.stereotype.ForeignKey(domain = "STyId", label = "Equipment", fkDefinition = "DtEquipment" )
