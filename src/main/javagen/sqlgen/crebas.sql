...
alter table BASE
	add constraint FK__A_BASE_BASETYPE_BASE_TYPE foreign key (BASE_TYPE_ID)
	references BASE_TYPE (BASE_TYPE_ID);

create index _A_BASE_BASETYPE_BASE_TYPE_FK on BASE (BASE_TYPE_ID asc);

alter table EQUIPMENT
	add constraint FK__A_BASE_EQUIPMENT_BASE foreign key (BASE_ID)
	references BASE (BASE_ID);

create index _A_BASE_EQUIPMENT_BASE_FK on EQUIPMENT (BASE_ID asc);

alter table BASE
	add constraint FK__A_BASE_GEOSECTOR_GEOSECTOR foreign key (GEOSECTOR_ID)
	references GEOSECTOR (GEOSECTOR_ID);

create index _A_BASE_GEOSECTOR_GEOSECTOR_FK on BASE (GEOSECTOR_ID asc);

alter table PICTURE
	add constraint FK__A_BASE_PICTURE_BASE foreign key (BASE_ID)
	references BASE (BASE_ID);

create index _A_BASE_PICTURE_BASE_FK on PICTURE (BASE_ID asc);

alter table EQUIPMENT
	add constraint FK__A_BUSINESS_EQUIPMENT_BUSINESS foreign key (BUSINESS_ID)
	references BUSINESS (BUSINESS_ID);

create index _A_BUSINESS_EQUIPMENT_BUSINESS_FK on EQUIPMENT (BUSINESS_ID asc);

alter table MISSION
	add constraint FK__A_BUSINESS_MISSION_BUSINESS foreign key (BUSINESS_ID)
	references BUSINESS (BUSINESS_ID);

create index _A_BUSINESS_MISSION_BUSINESS_FK on MISSION (BUSINESS_ID asc);

alter table EQUIPMENT_FEATURE
	add constraint FK__A_EQUIPMENT_EQUIPMENT_FEATURE_EQUIPMENT foreign key (EQUIPMENT_ID)
	references EQUIPMENT (EQUIPMENT_ID);

create index _A_EQUIPMENT_EQUIPMENT_FEATURE_EQUIPMENT_FK on EQUIPMENT_FEATURE (EQUIPMENT_ID asc);

alter table EQUIPMENT
	add constraint FK__A_EQUIPMENT_EQUIPMENT_TYPE_EQUIPMENT_TYPE foreign key (EQUIPMENT_TYPE_ID)
	references EQUIPMENT_TYPE (EQUIPMENT_TYPE_ID);

create index _A_EQUIPMENT_EQUIPMENT_TYPE_EQUIPMENT_TYPE_FK on EQUIPMENT (EQUIPMENT_TYPE_ID asc);

alter table EQUIPMENT
	add constraint FK__A_EQUIPMENT_GEOSECTOR_GEOSECTOR foreign key (GEOSECTOR_ID)
	references GEOSECTOR (GEOSECTOR_ID);

create index _A_EQUIPMENT_GEOSECTOR_GEOSECTOR_FK on EQUIPMENT (GEOSECTOR_ID asc);

alter table TICKET
	add constraint FK__A_EQUIPMENT_TICKET_EQUIPMENT foreign key (EQUIPMENT_ID)
	references EQUIPMENT (EQUIPMENT_ID);

create index _A_EQUIPMENT_TICKET_EQUIPMENT_FK on TICKET (EQUIPMENT_ID asc);

alter table EQUIPMENT_TYPE
	add constraint FK__A_EQUIPMENT_TYPE_EQUIPMENT_CATEGORY_EQUIPMENT_CATEGORY foreign key (EQUIPMENT_CATEGORY_ID)
	references EQUIPMENT_CATEGORY (EQUIPMENT_CATEGORY_ID);

create index _A_EQUIPMENT_TYPE_EQUIPMENT_CATEGORY_EQUIPMENT_CATEGORY_FK on EQUIPMENT_TYPE (EQUIPMENT_CATEGORY_ID asc);

alter table MISSION
	add constraint FK__A_MISSION_BASE_BASE foreign key (BASE_ID)
	references BASE (BASE_ID);

create index _A_MISSION_BASE_BASE_FK on MISSION (BASE_ID asc);

alter table OPENDATA_SET
	add constraint FK__A_OPENDATA_SET_OPENDATA_SET_STATUS_OPENDATA_SET_STATUS foreign key (OPENDATA_SET_STATUS_ID)
	references OPENDATA_SET_STATUS (OPENDATA_SET_STATUS_ID);

create index _A_OPENDATA_SET_OPENDATA_SET_STATUS_OPENDATA_SET_STATUS_FK on OPENDATA_SET (OPENDATA_SET_STATUS_ID asc);

alter table PERSON
	add constraint FK__A_PERSON_GROUPS_GROUPS foreign key (GROUP_ID)
	references GROUPS (GROUP_ID);

create index _A_PERSON_GROUPS_GROUPS_FK on PERSON (GROUP_ID asc);

alter table MISSION
	add constraint FK__A_PERSON_MISSION_PERSON foreign key (PERSON_ID)
	references PERSON (PERSON_ID);

create index _A_PERSON_MISSION_PERSON_FK on MISSION (PERSON_ID asc);

alter table TICKET
	add constraint FK__A_TICKET_TICKET_STATUS_TICKET_STATUS foreign key (TICKET_STATUS_ID)
	references TICKET_STATUS (TICKET_STATUS_ID);

create index _A_TICKET_TICKET_STATUS_TICKET_STATUS_FK on TICKET (TICKET_STATUS_ID asc);

alter table WORK_ORDER
	add constraint FK__A_TICKET_WORK_ORDER_TICKET foreign key (TICKET_ID)
	references TICKET (TICKET_ID);

create index _A_TICKET_WORK_ORDER_TICKET_FK on WORK_ORDER (TICKET_ID asc);

alter table WORK_ORDER
	add constraint FK__A_WORK_ORDER_WORK_ORDER_STATUS_WORK_ORDER_STATUS foreign key (WORK_ORDER_STATUS_ID)
	references WORK_ORDER_STATUS (WORK_ORDER_STATUS_ID);

create index _A_WORK_ORDER_WORK_ORDER_STATUS_WORK_ORDER_STATUS_FK on WORK_ORDER (WORK_ORDER_STATUS_ID asc);
